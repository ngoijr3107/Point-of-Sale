    ...
    <div class="row">
        <div class="col-xs-12">
            <div style="text-align: center;margin-bottom: 25px;">
                <img width="180" src="{{ public_path('images/logo_web.png') }}" alt="Logo">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-xs-4 mb-3 mb-md-0">
                            ...
                            <div>TIN: 114-430-854</div>
                            <div>VRN: 40-046468-J</div>
                        </div>
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            ...
                            @if ($sale->payment_status !== 'Paid')
                                <div>
                                    Due Amount: <strong>{{ format_currency($sale->due_amount) }}</strong>
                                </div>
                            @endif
                        </div>
                    ...
                    {{-- <div class="row" style="margin-top: 25px; margin-bottom: 25px; border-top: 1px solid #dddddd;">
